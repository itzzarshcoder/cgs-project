      ...
      <div className="bg-white-50 min-h-screen">
        ...
        <div className="bg-white p-6 border-b border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <Button
              variant="outline"
              className="rounded-full border border-gray-300 bg-[#EBEBEB] text-gray-700 hover:bg-gray-200 flex items-center gap-2"
        ...
        <Dialog open={dateFilterOpen} onOpenChange={setDateFilterOpen}>
          <DialogContent className="w-full max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Select a start and end date to view reports within that range.
              </DialogDescription>
            </DialogHeader>
